...
(function(root){
  ...
  *     @param model.path {String} Path to the file beneath the server-specified root path.
  *     @param [model.tail=false] {Boolean} false:text contains current file content, true: text contains last changes.
